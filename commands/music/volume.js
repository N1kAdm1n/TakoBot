module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (!args[0] || isNaN(args[0]) || args[0] === 'Infinity') return message.channel.send(`Введи правильное число!`);

        if (Math.round(parseInt(args[0])) < 1 || Math.round(parseInt(args[0])) > 100) return message.channel.send(`Введи правильное число! (между 1 и 100) !`);
